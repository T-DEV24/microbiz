...
public interface FournisseurRepository extends JpaRepository<Fournisseur, Long> {
    ...
    Optional<Fournisseur> findByIdAndTenantKey(Long id, String tenantKey);
    Optional<Fournisseur> findByTenantKeyAndEmailIgnoreCase(String tenantKey, String email);
}
