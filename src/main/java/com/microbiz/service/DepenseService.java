...
public class DepenseService {
    ...
    public List<Depense> findAll() {
        ...
        return depenseRepository.findAllByTenantKeyOrderByDateDepenseDesc(tenant);
    }
    ...
    public List<Depense> getDepensesParPeriode(LocalDate debut, LocalDate fin) {
        String tenant = TenantContext.getTenant();
        return depenseRepository.findByTenantKeyAndDateDepenseBetweenOrderByDateDepenseDesc(tenant, debut, fin);
    }
    ...
    public Map<String, Double> getDepensesParCategorie(LocalDate debut, LocalDate fin) {
        ...
        for (Depense depense : depenseRepository.findByTenantKeyAndDateDepenseBetweenOrderByDateDepenseDesc(TenantContext.getTenant(), debut, fin)) {
    ...
    public Map<String, Double> getDepensesParCategorie() {
        Map<String, Double> result = new LinkedHashMap<>();
        for (Object[] row : depenseRepository.getDepensesParCategorie(TenantContext.getTenant())) {
